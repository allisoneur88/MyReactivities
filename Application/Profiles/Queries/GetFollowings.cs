...
{
    public class Querie : IRequest<Result<List<UserProfile>>>
    {
        public string Predicate { get; set; } = "followers";
        public required string UserId { get; set; }
    }

    public class Handler(AppDbContext context, IMapper mapper, IUserAccessor userAccessor) : IRequestHandler<Querie, Result<List<UserProfile>>>
    {
        public async Task<Result<List<UserProfile>>> Handle(Querie request, CancellationToken cancellationToken)
        {
